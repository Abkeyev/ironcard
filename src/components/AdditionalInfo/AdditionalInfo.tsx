...
const Tarifs = () => {
  ...
  const rows = [
    ...
    { code: "Стоимость выпуска", value: "30 000 скидка 50% в течение января" },
    {
      ...
      value:
        "Бесплатно в случае: <br/>1. Транзакции по карте в месяц от 1 000 000 ₸ <br/>2. Депозит/Остаток на карте от 15 000 000 ₸ <br/><span>В прочих случаях - 10 000 KZT в месяц</span>"
    },
    {
      code: "Cashback",
      value:
    ...
    {
      code: "Переводы на карту другого клиента внутри Банка",
      value: "Бесплатно"
    },
    {
