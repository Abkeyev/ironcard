...
const Tarifs = () => {
  ...
  const rows = [
    ...
    { code: "Стоимость выпуска", value: "30 000 скидка 50% в течение января" },
    {
      ...
      value:
        "Бесплатно в случае: <br/>1. Безналичная оплата в месяц от 1 000 000 ₸ <br/>2. Депозит Рахмет/Рахмет+ на сумму от 15 млн тенге (количество депозитов суммируется)<br/>3. Добавить депозиты в валюте от 40 тыс. евро или долларов<br/><span>В прочих случаях - 10 000 KZT в месяц</span>"
    },
    {
      code: "Cashback",
      value:
