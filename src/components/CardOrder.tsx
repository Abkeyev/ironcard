...
const CardOrder = (props: any) => {
  ...
  const generateUrl = () => {
    ...
    let desc = encodeURIComponent(
      `${phone.replace(/\+|\(|\)| /g, "")}-${iin}-${transliterate(city)}-${cardType === 3
        ? "tiffany"
        : cardType === 2
          ? "rose"
          : cardType === 1
    ...
    let url = `https://test3ds.bcc.kz:5445/cgi-bin/cgi_link/?AMOUNT=30000&CURRENCY=398&ORDER=${order}&DESC=${desc}&NAME=${nameOnCard}&MERCHANT=${merchant}&TERMINAL=${terminal}&MERCH_GMT=6&TIMESTAMP=${timestamp}&TRTYPE=1&NONCE=${nonce}&P_SIGN=${pSign}&LANG=RU&BACKREF=${backref}`
    ...
    switch (step) {
      ...
      case 1:
        return (
          <>
            <Grid
              className={`${classes.changeCard} ${cardType === 3
                ? classes.tiffany
                : cardType === 2
                  ? classes.rose
                  : cardType === 1
          ...
          <div className={classes.progress}>
            ...
            <div className={classes.progress}>
              ...
              <div className={classes.progressBar}>
                ...
                <div
                  style={{
                    width: `${step === 3 ? "33" : step === 4 ? "100" : step * 33
                      }%`,
                  }}
