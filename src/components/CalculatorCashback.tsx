                        ...
                        <Grid container>
                            ...
                            <Grid item xl={6} lg={6} md={6} sm={6} xs={6}>
                                <Grid container justify="flex-end">
                                    <Typography className={classes.monthSpendingInterval}>3 000 000</Typography>
                                </Grid>
                            </Grid>
                            <Grid item xl={12} lg={12} md={12} sm={12} xs={12}>
                                <Typography className={classes.note}>* В расчет для примера взят кешбэк на все операции 2%</Typography>
                            </Grid>
                        </Grid>
                    </Grid>
