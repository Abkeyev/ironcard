    ...
    createStyles({
        ...
        [theme.breakpoints.down('sm')]: {
            ...
            ironCard: {
                ...
                color: 'white',
                '& > span': {
                    background: 'linear-gradient(to bottom, #27AE60 0%, rgba(39, 174, 96, 0.4) 100%)',
            ...
            <Grid container className={classes.root}>
                ...
                <Grid item xl={12} lg={12} md={12} sm={12} xs={12}>
                    <Grid container className={classes.cardDescriptionBlock}>
                        <Grid item xl={12} lg={12} md={12} sm={12} xs={12} style={{zIndex: 5}}>
                            <Typography className={classes.cardTitle}>Первая бесконтактная<br/>
                            металлическая карта в Казахстане</Typography>
                        </Grid>
                        <Grid item xl={12} lg={12} md={12} sm={12} xs={12} style={{zIndex: 5}}>
                            <Typography className={classes.cardWhatYourWant}>Статус имеет значение!</Typography>
                        </Grid>
                        <Grid item xl={12} lg={12} md={12} sm={12} xs={12}>
                ...
                <Grid container>
                    ...
                    <Grid item xl={12} lg={12} md={12} sm={12} xs={12}>
                        <Typography className={classes.ironCardDescriptionBlock}>
                            Карта подчеркивает статус и престиж владельца. Это высочайший<br/>уровень заботы, безопасности и конфиденциальности
                        </Typography>
                    </Grid>
                    <Grid item container xl={12} lg={12} md={12} sm={12} xs={12} justify="space-between">
                        <Grid item xl={2} lg={2} md={2} sm={12} xs={12}>
                            <div className={classes.circleWrap}>
                                <div className={classes.circleInner}>
                                    <img className={classes.circleImg} src="hammer.svg"/>
                                </div>
                            </div>
                            <span className={classes.circleUnderText}>Первоклассная сталь<br/>как для острых мечей</span>
                        </Grid>
                        <Grid item xl={3} lg={3} md={3} sm={12} xs={12} className={classes.signStyle}>
                            +
                        </Grid>
                        <Grid item xl={2} lg={2} md={2} sm={12} xs={12}>
                            <div className={classes.circleWrap}>
                                <div className={classes.circleInner}>
                                    <img className={classes.circleImg} src="brain.svg"/>
                                </div>
                            </div>
                            <span className={classes.circleUnderText}>Современные технологии<br/>для комфорта</span>
                        </Grid>
                        <Grid item xl={3} lg={3} md={3} sm={12} xs={12} className={classes.signStyle}>
                            =
                        </Grid>
                        <Grid item xl={2} lg={2} md={2} sm={12} xs={12}>
                            <img className={classes.ironCardImg} src="IconCard-first.svg"/>
                            <span className={classes.circleUnderText}>Карта всего <b>17 грамм</b>,<br/><b>15 грамм</b> нержавеющей стали</span>
                        </Grid>
                    </Grid>
                </Grid>
                <Grid
                ...
                >
                    <Grid item xl={6} lg={6} md={6} sm={12} xs={12} className={classes.cardMFeatures}>
